...
DATE_PATTERN = r"\b\d{1,2}[-/]\d{1,2}[-/]\d{2,4}\b"  # e.g., 10-Sep-2025, 10/09/2025
...
def extract_metadata(text: str) -> Dict[str, List[str]]:
    ...
    keywords = []
    department_keywords = [
        "Operations", "Maintenance", "Engineering", "Infrastructure", "Electrical", "Mechanical",
        "Finance", "Accounts", "HR", "Legal", "Compliance", "Procurement", "Contracts",
        "Corporate Communications", "Business Development", "Vigilance", "Security",
        "IT", "Planning", "Environment", "Sustainability", "Customer Relations", "Project Management"
    ]
